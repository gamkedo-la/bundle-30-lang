...
function FeedGrabberPlayer()
{
  ...
  this.draw = function()
  {
    drawFromSheet(this.leftPac, 0,0, 50,50);

    drawFromSheet(this.rightPac, gameCanvas.width - 50,0, 50,50);
...
function feedGameClass()
{
  ...
  this.superInitialize = function()
  {
    ...
    this.leftPacMan = new PacMan(0, "images\\sprites\\feedGame\\leftP.png");
    this.rightPacMan = new PacMan(0, "images\\sprites\\feedGame\\rightP.png")
